...
BEGIN
    ...
    INSERT INTO blocks (id, note_id, block_type_id, position, content, formatting, created_at, updated_at) VALUES
    (block_id, note_record.id, 1, 0, 
     ...
     '{"bold": false, "italic": false, "underline": false, "text_align": -1}'::jsonb,
    ...
    (block_id, note_record.id, 1, 1,
     ...
     '{"bold": true, "italic": false, "underline": false, "text_align": -1}'::jsonb,
     NOW() - INTERVAL '1 month', NOW());
    ...
    (block_id, note_record.id, 1, 2,
     ...
     '{"bold": false, "italic": true, "underline": false, "text_align": -1}'::jsonb,
     NOW() - INTERVAL '1 month', NOW());
    ...
    (block_id, note_record.id, 1, 0,
     ...
     '{"bold": false, "italic": false, "underline": true, "text_align": -1}'::jsonb,
    ...
    (block_id, note_record.id, 1, 1,
     ...
     '{"bold": true, "italic": true, "underline": false, "text_align": 0}'::jsonb,
     NOW() - INTERVAL '2 months', NOW());
    ...
    (block_id, note_record.id, 1, 1,
     ...
     '{"bold": true, "italic": false, "underline": true, "text_align": -1}'::jsonb,
     NOW() - INTERVAL '3 months', NOW());
    ...
    (block_id, note_record.id, 1, 2,
     ...
     '{"bold": false, "italic": true, "underline": true, "text_align": 0}'::jsonb,
     NOW() - INTERVAL '3 months', NOW());
    ...
    (block_id, note_record.id, 1, 2,
     ...
     '{"bold": false, "italic": true, "underline": true, "text_align": -1}'::jsonb,
     NOW() - INTERVAL '4 months', NOW());
    ...
    (block_id, note_record.id, 1, 1,
     ...
     '{"bold": true, "italic": true, "underline": true, "text_align": 0}'::jsonb,
     NOW() - INTERVAL '5 months', NOW());
