...
//
//	mockgen -source=auth.go -destination=mocks/mock_user_repository.go -package=usecase
//
...
func (m *MockUserRepository) CreateUser(ctx context.Context, login, password string) (*models.Profile, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) GetUserByLogin(ctx context.Context, login string) (*models.Profile, error) {
	m.ctrl.T.Helper()
