...
const (
	...
	AuthService_SigninUser_FullMethodName = "/auth.AuthService/SigninUser"
...
type AuthServiceClient interface {
	...
	SigninUser(ctx context.Context, in *SigninRequest, opts ...grpc.CallOption) (*UserResponse, error)
...
func (c *authServiceClient) SignupUser(ctx context.Context, in *SignupRequest, opts ...grpc.CallOption) (*UserResponse, error) {
...
func (c *authServiceClient) SigninUser(ctx context.Context, in *SigninRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserResponse)
...
type AuthServiceServer interface {
	...
	SigninUser(context.Context, *SigninRequest) (*UserResponse, error)
...
func (UnimplementedAuthServiceServer) SignupUser(context.Context, *SignupRequest) (*UserResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SignupUser not implemented")
}
func (UnimplementedAuthServiceServer) SigninUser(context.Context, *SigninRequest) (*UserResponse, error) {
...
func _AuthService_SigninUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).SigninUser(ctx, req.(*SigninRequest))
	}
	return interceptor(ctx, in, info, handler)
}
